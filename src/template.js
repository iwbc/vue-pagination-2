module.exports = function() {
  ...
  return function(h) {
    ...
    if (this.opts.chunksNavigation==='fixed') {
      ...
      domPropsInnerHTML={this.opts.texts.prevChunk}></a>
      </li>
      ...
      href="javascript:void(0);"
      disabled={!!this.allowedChunkClass(1)}
      domPropsInnerHTML={this.opts.texts.nextChunk}></a>
      </li>;
    ...
    domPropsInnerHTML={this.opts.texts.prevPage}></a>
    </li>
    {items}
    ...
    href="javascript:void(0);"
    disabled={!!this.allowedPageClass(this.page+1)}
    domPropsInnerHTML={this.opts.texts.nextPage}></a>
    </li>
    {nextChunk}
    {lastPage}
    </ul>
